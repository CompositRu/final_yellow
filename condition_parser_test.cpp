...
//		root->Print({2017, 1, 1}, "");
//		cerr << endl;
//		cerr << "my test >=: " << (Date{2017, 1, 1} >= Date{2017, 1, 1}) << endl;
//		cerr << "my test <: " << (Date{2017, 1, 1} < Date{2017, 7, 1}) << endl;
//		cerr << "my test Compare <: " << Compare(Comparison::Less, Date{2017, 1, 1}, Date{2017, 7, 1}) << endl;
//		cerr << "my test ParseDate <: " << Compare(Comparison::Less, ParseDate("2017-01-01"), ParseDate("2017-07-01")) << endl;
//		istringstream is1("2017-01-01");
//		istringstream is2("2017-07-01");
//		cerr << "my test ParseDate stream <: " << Compare(Comparison::Less, ParseDate(is1), ParseDate(is2)) << endl;
//	}
  {
